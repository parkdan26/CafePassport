"""
Django settings for CafePassport project.
...
ROOT_URLCONF = 'CafePassport.urls'
...
WSGI_APPLICATION = 'CafePassport.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'authentication.JWTauth.CookieJWTAuthentication',
    ),
